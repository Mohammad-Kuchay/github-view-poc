      ...
      {repository && (
        <div className="max-w-7xl mx-auto mt-12">
          <div className="flex gap-5">
            <button
              className="px-3 py-2 rounded-md bg-gray-100 text-gray-500 hover:bg-gray-200 transition"
              onClick={() => navigate("/")}
            >
              Go Back
            </button>
            ...
            >
              ...
              <span className="block">View in GitHub</span>
            </a>
          </div>
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <div className="flex items-center gap-5 mt-2 text-gray-600">
                  ...
                  <p>
                    Language{" "}
                    <span className="font-semibold">{repository.language}</span>
                  </p>
                </div>
              </div>
            </div>
